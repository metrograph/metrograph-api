...
async def start_background_scheduler(app):
    ...
    for schedule in get_active_schedules():
        ...
        schedule_action(schedule_uuid=schedule["uuid"], action_uuid=schedule["action_uuid"], weeks=schedule["weeks"], days=schedule["days"], hours=schedule["hours"], minutes=schedule["minutes"], seconds=schedule["seconds"], at=schedule["at"])
